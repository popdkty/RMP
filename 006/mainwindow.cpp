    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
  ...
  setMenu();
  trayIcon->show();
  connect(trayIcon, SIG-NAL(activated(QSystemTrayIcon::ActivationReason)),
...
void MainWindow::tray()
{
  if(this->isVisible()){
    this->hide();
    QSystemTrayIcon::MessageIcon icon = QSys-temTrayIcon::MessageIcon(QSystemTrayIcon::Information);
...
void Main-Window::iconActivated(QSystemTrayIcon::ActivationReason reason)
{
  switch (reason){
